...
@section('page_heading', 'Tambah Pendidikan')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div class="p-6 bg-rose-950 text-white border-b border-rose-900">
            <h2 class="text-lg font-bold">Form Tambah Riwayat Pendidikan</h2>
            <p class="text-xs text-rose-200/80 mt-1">Lengkapi informasi latar belakang pendidikan Anda di bawah ini.</p>
        </div>
